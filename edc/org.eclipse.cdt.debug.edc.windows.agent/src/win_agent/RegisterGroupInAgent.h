...
public:
	RegisterGroupInAgent(const std::string& name, ContextID& parentID, Properties& props);

	static std::string& createInternalID(const std::string& name, std::string& parentID);
};
