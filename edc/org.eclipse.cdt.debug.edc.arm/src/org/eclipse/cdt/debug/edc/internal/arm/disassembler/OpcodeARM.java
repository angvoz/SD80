...
public class OpcodeARM {
	...
	public enum Index {
		arm_adc, arm_add, arm_and, arm_b, arm_bl, arm_bic, arm_bkpt, arm_undefined, 
		arm_blx1, arm_blx2, arm_bx, 
		arm_cdp, arm_cdp2, arm_clz, arm_cmn, arm_cmp, arm_eor, 
		arm_ldc, arm_ldc2, arm_ldm1, arm_ldm2, arm_ldm3, 
		arm_ldr, arm_ldrb, arm_ldrbt, arm_ldrd, arm_ldrh, 
		arm_ldrsb, arm_ldrsh, arm_ldrt, 
		arm_mcr, arm_mcr2, arm_mcrr, arm_mcrr2, arm_mla, arm_mov, 
		arm_mrc, arm_mrc2, arm_mrrc, arm_mrrc2, arm_mrs, 
		arm_msr, arm_msr2, arm_mul, arm_mvn, 
		arm_orr, arm_pld, arm_qadd, arm_qdadd, arm_qdsub, 
		arm_qsub, arm_rsb, arm_rsc, 
		arm_sbc, arm_smla, arm_smlal, arm_smlalxy, arm_smlaw, 
		arm_smul, arm_smull, arm_smulw, 
		arm_stc, arm_stc2, arm_stm1, arm_stm2, arm_str, 
		arm_strb, arm_strbt, arm_strd, arm_strh, arm_strt, 
		arm_sub, arm_swi, arm_swp, arm_swpb, arm_teq, arm_tst, 
		arm_umlal, arm_umull, arm_bxj, 
		arm_cps, arm_cpsid, arm_cpsie, arm_cpy, 
		arm_pkhbt, arm_pkhtb, arm_rev, arm_rev16, arm_revsh, 
		arm_rfeia, arm_rfeib, arm_rfeda, arm_rfedb, 
		arm_setend, arm_smmul, arm_smmulr, 
		arm_srsia, arm_srsib, arm_srsda, arm_srsdb, 
		arm_ssat, arm_ssat16, arm_sxtb, arm_sxtb16, arm_sxth, 
		arm_usat, arm_usat16, arm_uxtb, arm_uxtb16, arm_uxth, 
		arm_qadd16, arm_qadd8, arm_qaddsubx, arm_qsub16, arm_qsub8, arm_qsubaddx, 
		arm_sadd16, arm_sadd8, arm_saddsubx, arm_sel, 
		arm_shadd16, arm_shadd8, arm_shaddsubx, arm_shsub16, 
		arm_shsub8, arm_shsubaddx, 
		arm_smlald, arm_smlaldx, arm_smlsld, arm_smlsldx, arm_smmls, arm_smmlsr, 
		arm_smuad, arm_smuadx, arm_smusd, arm_smusdx, 
		arm_ssub16, arm_ssub8, arm_ssubaddx, arm_uadd16, 
		arm_uadd8, arm_uaddsubx, 
		arm_uhadd16, arm_uhadd8, arm_uhaddsubx, arm_uhsub16, 
		arm_uhsub8, arm_uhsubaddx, 
		arm_uqadd16, arm_uqadd8, arm_uqaddsubx, arm_uqsub16, 
		arm_uqsub8, arm_uqsubaddx, 
		arm_usad8, arm_usada8, arm_usub16, arm_usub8, arm_usubaddx, 
		arm_smmla, arm_smmlar, arm_smlsd, arm_smlsdx, 
		arm_smlad, arm_smladx, 
		arm_uxtab, arm_uxtab16, arm_uxtah, arm_sxtab, 
		arm_sxtab16, arm_sxtah, 
		arm_fabsd, arm_fabss, arm_faddd, arm_fadds, 
		arm_fcmpd, arm_fcmped, arm_fcmpes, arm_fcmpezd, 
		arm_fcmpezs, arm_fcmps, arm_fcmpzd, arm_fcmpzs, 
		arm_fcpyd, arm_fcpys, arm_fcvtds, arm_fcvtsd, 
		arm_fdivd, arm_fdivs, 
		arm_fldd, arm_fldmd, arm_fldms, arm_flds, 
		arm_fmacd, arm_fmacs, arm_fmdhr, arm_fmdlr, arm_fmdrr, arm_fmrdh, 
		arm_fmrdl, arm_fmrrd, arm_fmrrs, arm_fmrs, arm_fmrx, arm_fmscd, 
		arm_fmscs, arm_fmsr, arm_fmsrr, arm_fmstat, arm_fmuld, arm_fmuls, 
		arm_fmxr, arm_fnegd, arm_fnegs, arm_fnmacd, arm_fnmacs, arm_fnmscd, 
		arm_fnmscs, arm_fnmuld, arm_fnmuls, arm_fsitod, arm_fsitos, arm_fsqrtd, 
		arm_fsqrts, arm_fstd, arm_fstmd, arm_fstms, arm_fsts, arm_fsubd, arm_fsubs, 
		arm_ftosid, arm_ftosis, arm_ftouid, arm_ftouis, arm_fuitod, arm_fuitos, 
		
		thumb_adc, thumb_add1, thumb_add2, thumb_add3, 
		thumb_add4, thumb_add5, thumb_add6,
		thumb_add7, thumb_and, thumb_asr1, thumb_asr2, 
		thumb_b1, thumb_b2, thumb_bic, 
		thumb_bkpt, thumb_blx1, thumb_blx2, thumb_bx, 
		thumb_cmn, thumb_cmp1, thumb_cmp2, 
		thumb_cmp3, thumb_cps, thumb_cpy, thumb_eor, 
		thumb_ldmia, thumb_ldr1, thumb_ldr2, 
		thumb_ldr3, thumb_ldr4, thumb_ldrb1, thumb_ldrb2, 
		thumb_ldrh1, thumb_ldrh2, 
		thumb_ldrsb, thumb_ldrsh, 
		thumb_lsl1, thumb_lsl2,	thumb_lsr1, thumb_lsr2, 
		thumb_mov1, thumb_mov2, thumb_mov3, thumb_mul, 
		thumb_mvn, thumb_neg, thumb_orr, 
		thumb_pop, thumb_push, thumb_rev, thumb_rev16, 
		thumb_revsh, thumb_ror, 
		thumb_sbc, thumb_setend, thumb_stmia, thumb_str1, 
		thumb_str2, thumb_str3, 
		thumb_strb1, thumb_strb2, thumb_strh1, thumb_strh2, 
		thumb_sub1, thumb_sub2, thumb_sub3, thumb_sub4, 
		thumb_swi, thumb_sxtb,
		thumb_sxth, thumb_tst, thumb_uxtb, thumb_uxth, 
		thumb_undefined,
	...
	public static final OpcodeARM arm_opcode_table[] = {
			...
			new OpcodeARM(Index.arm_ldrb, "ldrb", "xxxx01xxx1x1xxxxxxxxxxxxxxx0xxxx"),
	...
	public static final OpcodeARM thumb_opcode_table[] = { new OpcodeARM(Index.thumb_mov2, "mov", "0001110000xxxxxx"),
			new OpcodeARM(Index.thumb_mov3, "mov", "01000110xxxxxxxx"),
