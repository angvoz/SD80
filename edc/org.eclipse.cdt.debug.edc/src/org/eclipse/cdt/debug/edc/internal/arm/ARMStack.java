...
public class ARMStack extends Stack {
	...
	protected List<Map<String, Object>> computeStackFrames(ExecutionDMC context) {
		...
		while (frameCount < MAX_FRAMES) {
			...
			ModuleDMC module = modules.getModuleByAddress(context.getSymbolDMContext(), pcValue);
			if (module != null) {
	...
	private IAddress findProlog(ExecutionDMC context, IAddress pcValue, boolean thumbMode) {
	...
	private SpilledRegisters parseArmProlog(ExecutionDMC context, List<BigInteger> instructions, IAddress spValue) {
		SpilledRegisters spilledRegs = new SpilledRegisters();
