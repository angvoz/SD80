...
public class DwarfConstants {
	...
	public final static int DW_AT_allocated = 0x4e; // DWARF 3
	public final static int DW_AT_associated = 0x4f; // DWARF 3
	public final static int DW_AT_data_location = 0x50; // DWARF 3
	public final static int DW_AT_byte_stride = 0x51; // DWARF 3
	public final static int DW_AT_entry_pc = 0x52; // DWARF 3
	public final static int DW_AT_use_UTF8 = 0x53; // DWARF 3
	public final static int DW_AT_extension = 0x54; // DWARF 3
	public final static int DW_AT_ranges = 0x55; // DWARF 3
	public final static int DW_AT_trampoline = 0x56; // DWARF 3
	public final static int DW_AT_call_column = 0x57; // DWARF 3
	public final static int DW_AT_call_file = 0x58; // DWARF 3
	public final static int DW_AT_call_line = 0x59; // DWARF 3
	public final static int DW_AT_description = 0x5a; // DWARF 3
	public final static int DW_AT_binary_scale = 0x5b; // DWARF 3
	public final static int DW_AT_decimal_scale = 0x5c; // DWARF 3
	public final static int DW_AT_small = 0x5d; // DWARF 3
	public final static int DW_AT_decimal_sign = 0x5e; // DWARF 3
	public final static int DW_AT_digit_count = 0x5f; // DWARF 3
	public final static int DW_AT_picture_string = 0x60; // DWARF 3
	public final static int DW_AT_mutable = 0x61; // DWARF 3
	public final static int DW_AT_threads_scaled = 0x62; // DWARF 3
	public final static int DW_AT_explicit = 0x63; // DWARF 3
	public final static int DW_AT_object_pointer = 0x64; // DWARF 3
	public final static int DW_AT_endianity = 0x65; // DWARF 3
	public final static int DW_AT_elemental = 0x66; // DWARF 3
	public final static int DW_AT_pure = 0x67; // DWARF 3
	public final static int DW_AT_recursive = 0x68; // DWARF 3
