 ...
 *
 */
public class ProcessInAgent extends ContextInAgent {
	 ...
	 * 
	 * @param osID  ID of the process in target OS. 
	 * @param props initial properties, can be null.
	...
	public ProcessInAgent(long osID, Map<String, Object> props, boolean cacheAsDebugged) {
		...
		internalProps.put(IRunControl.PROP_PROCESS_ID, Long.toString(osID));
	...
	/**
	 * Create internal unique ID with the given process ID in target OS.
	 * This method ensures the same internal ID is generated for the same
	 * OS process ID.
	 * 
	 * @param osID
	 * @return
