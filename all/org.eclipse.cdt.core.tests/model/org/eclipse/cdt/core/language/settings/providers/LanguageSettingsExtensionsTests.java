...
public class LanguageSettingsExtensionsTests extends TestCase {
	...
	public void testExtension() throws Exception {
		{
			List<ILanguageSettingsProvider> providers = LanguageSettingsExtensionManager.getExtensionProviders();
		...
		ILanguageSettingsProvider providerExt = LanguageSettingsExtensionManager.getExtensionProvider(DEFAULT_PROVIDER_ID_EXT);
		assertNotNull(providerExt);
		assertTrue(LanguageSettingsExtensionManager.isExtensionProvider(providerExt));
	...
	public void testExtensionBaseProviderSubclass() throws Exception {
		// get test plugin extension provider
		ILanguageSettingsProvider providerExt = LanguageSettingsExtensionManager.getExtensionProvider(BASE_PROVIDER_SUBCLASS_ID_EXT);
		assertNotNull(providerExt);
