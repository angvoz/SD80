...
class InstructionPointerManager {
	 ...
	 */
	private static final String ID_CURRENT_IP= "org.eclipse.cdt.debug.edc.ui.currentIP"; //$NON-NLS-1$
	
    /**
	 * Secondary instruction pointer annotation type.
	 */
	private static final String ID_SECONDARY_IP= "org.eclipse.cdt.debug.edc.ui.secondaryIP"; //$NON-NLS-1$
