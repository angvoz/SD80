 ...
 */
RegisterInAgent::RegisterInAgent(const std::string& name, std::string& parentID, Properties& props):
...
std::string& RegisterInAgent::createInternalID(const std::string& name, std::string& parentID) {
