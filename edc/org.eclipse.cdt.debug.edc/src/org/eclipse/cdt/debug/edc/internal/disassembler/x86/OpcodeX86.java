...
import org.eclipse.cdt.debug.edc.internal.disassembler.x86.InstructionParserX86.ModRM;
	...
	public static Map<Integer, OpcodeX86> sOpcodeMap_OneByte = new HashMap<Integer, OpcodeX86>() {
		{
			...
			AssemblyFormatter.sInstructionsNotReverseOperand.add("bound");
			...
			AssemblyFormatter.sInstructionsNotReverseOperand.add("movs" + SIZE_FLAG_TARGET);
			...
			AssemblyFormatter.sInstructionsNotReverseOperand.add("enter");
	...
	public static Map<Integer, OpcodeX86> sOpcodeMap_TwoByte = new HashMap<Integer, OpcodeX86>() {
		{
			...
			// "movzx".
			AssemblyFormatter.sInstructionsSuffixFromRegisterOperand.add("movzb" + SIZE_FLAG_TARGET);
			put(0xb7, new OpcodeX86("movzw" + SIZE_FLAG_TARGET, true, OD_Gv_Ew));
			AssemblyFormatter.sInstructionsSuffixFromRegisterOperand.add("movzw" + SIZE_FLAG_TARGET);
			...
			// "movsx".
			AssemblyFormatter.sInstructionsSuffixFromRegisterOperand.add("movsb" + SIZE_FLAG_TARGET);
			put(0xbf, new OpcodeX86("movsw" + SIZE_FLAG_TARGET, true, OD_Gv_Ew)); // Intel
			// "movsx"
			AssemblyFormatter.sInstructionsSuffixFromRegisterOperand.add("movsw" + SIZE_FLAG_TARGET);
