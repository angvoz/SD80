 ...
 */
RegisterGroupInAgent::RegisterGroupInAgent(const std::string& name, std::string& parentID, Properties& props):
...
std::string& RegisterGroupInAgent::createInternalID(const std::string& name, std::string& parentID) {
