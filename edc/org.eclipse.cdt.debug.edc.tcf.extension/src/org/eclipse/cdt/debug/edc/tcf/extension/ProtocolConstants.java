...
public interface ProtocolConstants {
	...
	public static interface IModuleProperty {
		public static final String PROP_FILE = "File", // module file name
				PROP_TIME = "Time", PROP_MODULE_LOADED = "Loaded", // Boolean,
				// whether
				// loaded or
				// unloaded.
				...
				PROP_IMAGE_BASE_ADDRESS = "ImageBaseAddress", // value type:
				// Number (Java
				// "Number").
