 ...
 *
 */
public class RegisterGroupInAgent extends ContextInAgent {

	/**
	 * Construct a register group context. The internal ID of the context will
	 ...
	 * @param parentID
	 *            internal ID of the parent (usually a thread context).
	 * @param props
	 *            initial properties, cannot be null but can be empty.
	 */
	public RegisterGroupInAgent(String name, String parentID, Map<String, Object> props) {
		super(props);
