...
public abstract class AbstractDisassembler implements IDisassembler {
	...
	public List<DisassembledInstruction> disassembleInstructions(IAddress startAddress, IAddress endAddress,
			ByteBuffer codeBuffer, Map<String, Object> options) throws CoreException {
		DisassembledInstruction inst = null;
		ArrayList<DisassembledInstruction> result = new ArrayList<DisassembledInstruction>();
