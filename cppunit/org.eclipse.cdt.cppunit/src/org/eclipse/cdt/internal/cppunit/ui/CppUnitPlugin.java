...
public class CppUnitPlugin extends AbstractUIPlugin implements ILaunchListener {	
	...
	public CppUnitPlugin(IPluginDescriptor desc) {
		super(desc);
		fgPlugin= this;
	...
	protected void initializeDefaultPreferences(IPreferenceStore store) {
		...
		CppUnitPreferencePage.initializeDefaults(store);
	}
...
//			System.out.println("Returning, cause not in the array");
	...
	{
		IPluginDescriptor i=getDefault().getDescriptor();
		URL base=i.getInstallURL();

		PlatformURLConnection c = null;
		try
		{
			c = (PlatformURLConnection) base.openConnection();
			String s=c.getURLAsLocal().getPath();
			return s;
		} catch (IOException e) {
			return null;
		}
